        ...
        <table data-toggle="table">
            ...
            <#list books as book>
                <tr>
                    ...
                    <td>${book.name!''}</td>
                    <td>${book.cost!''}</td>
                    <td>${book.activityId.name!''}</td>
                    <td>${book.authorId.lastName!''} ${book.authorId.firstName!''} ${book.authorId.middleName!''}</td>
                    <td>${book.formatId.name!''}</td>
                    <td>${book.genreId.name!''}</td>
                    <td>${book.publisherId.name!''}</td>
                    <td>${book.typeId.name!''}</td>
                    <td>${book.departmentId.name!''}</td>
                </tr>
            </#list>
            </tbody>
        </table>
